...
public class HQ2X {
		...
		private int YUV1, YUV2;
		private final int Ymask = 0x00FF0000;
		private final int Umask = 0x0000FF00;
		private final int Vmask = 0x000000FF;
		private final int trY   = 0x00300000;
		private final int trU   = 0x00000700;
		private final int trV   = 0x00000006;
		...
		private void hq2x_32(int[] in, int[] out, int Xres, int Yres)
		{
		int  i, j, k;
		int  outX = 0;
		int  outY = 0;
		...
		private int RGB8888toRGB565(int rgb)
		{
		...
		public int[] hq2x(int[] rgbIntArray, int w, int h)
		{
