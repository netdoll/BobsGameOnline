...
{//=========================================================================================================================
	...
	{//=========================================================================================================================
		...
		float tileWidth = glowTileFramesTexture[0].getWidth()*scale;
		float tileHeight = glowTileFramesTexture[0].getHeight()*scale;
		...
		//------------------------------------------
			...
			for(int i=glowTiles.size()-1;i>=0;i--)//from top to bottom
			{
				GlowTile tile = glowTiles.get(i);
					...
					float tXRatio = (float)texture.getWidth()/(float)texture.getWidth();
					float tYRatio = (float)texture.getHeight()/(float)texture.getHeight();
