...
{//=========================================================================================================================
	...
	public static com.badlogic.gdx.graphics.Texture mainFBO_lightTexture;
	public static com.badlogic.gdx.graphics.Texture mainFBO_Texture;

	public static com.badlogic.gdx.graphics.Texture nDFBO_Texture;
	public static com.badlogic.gdx.graphics.Texture nDFBO_MaskTexture;

	public static com.badlogic.gdx.graphics.Texture nDBloomFBO_Texture_0;
	public static com.badlogic.gdx.graphics.Texture nDBloomFBO_Texture_1;

	public static com.badlogic.gdx.graphics.Texture nDBGFBO_Texture_0;
	public static com.badlogic.gdx.graphics.Texture nDBGFBO_Texture_1;
	...
	public static void initGL(String windowName) {
        ...
        GL.createCapabilities();
...

			{
				...
				int mainFBO_Texture_ID = glGenTextures();
				LWJGLUtils.setupFBOTexture(mainFBO_Texture_ID, SCREEN_SIZE_X, SCREEN_SIZE_Y);
				mainFBO_Texture = GLUtils.wrapGLTexture(mainFBO_Texture_ID, SCREEN_SIZE_X, SCREEN_SIZE_Y);
				LWJGLUtils.attachTextureToFBO(0, mainFBO_Texture_ID);

				int mainFBO_lightTexture_ID = glGenTextures();
				LWJGLUtils.setupFBOTexture(mainFBO_lightTexture_ID, SCREEN_SIZE_X, SCREEN_SIZE_Y);
				mainFBO_lightTexture = GLUtils.wrapGLTexture(mainFBO_lightTexture_ID, SCREEN_SIZE_X, SCREEN_SIZE_Y);
				LWJGLUtils.attachTextureToFBO(1, mainFBO_lightTexture_ID);
				...
				int nDFBO_Texture_ID = glGenTextures();
				LWJGLUtils.setupFBOTexture(nDFBO_Texture_ID, ND.SCREEN_SIZE_X * ND.FBO_SCALE_MULTIPLIER, ND.SCREEN_SIZE_Y * ND.FBO_SCALE_MULTIPLIER);
				nDFBO_Texture = GLUtils.wrapGLTexture(nDFBO_Texture_ID, ND.SCREEN_SIZE_X * ND.FBO_SCALE_MULTIPLIER, ND.SCREEN_SIZE_Y * ND.FBO_SCALE_MULTIPLIER);
				LWJGLUtils.attachTextureToFBO(0, nDFBO_Texture_ID);

				int nDFBO_MaskTexture_ID = glGenTextures();
				LWJGLUtils.setupFBOTexture(nDFBO_MaskTexture_ID, ND.SCREEN_SIZE_X * ND.FBO_SCALE_MULTIPLIER, ND.SCREEN_SIZE_Y * ND.FBO_SCALE_MULTIPLIER);
				nDFBO_MaskTexture = GLUtils.wrapGLTexture(nDFBO_MaskTexture_ID, ND.SCREEN_SIZE_X * ND.FBO_SCALE_MULTIPLIER, ND.SCREEN_SIZE_Y * ND.FBO_SCALE_MULTIPLIER);
				LWJGLUtils.attachTextureToFBO(1, nDFBO_MaskTexture_ID);
				...
				int nDBloomFBO_Texture_0_ID = glGenTextures();
				LWJGLUtils.setupFBOTexture(nDBloomFBO_Texture_0_ID, (int) (ND.SCREEN_SIZE_X * ND.FBO_SCALE_MULTIPLIER * ND.BLOOM_FBO_SCALE), (int) (ND.SCREEN_SIZE_Y * ND.FBO_SCALE_MULTIPLIER * ND.BLOOM_FBO_SCALE));
				nDBloomFBO_Texture_0 = GLUtils.wrapGLTexture(nDBloomFBO_Texture_0_ID, (int) (ND.SCREEN_SIZE_X * ND.FBO_SCALE_MULTIPLIER * ND.BLOOM_FBO_SCALE), (int) (ND.SCREEN_SIZE_Y * ND.FBO_SCALE_MULTIPLIER * ND.BLOOM_FBO_SCALE));
				LWJGLUtils.attachTextureToFBO(0, nDBloomFBO_Texture_0_ID);

				int nDBloomFBO_Texture_1_ID = glGenTextures();
				LWJGLUtils.setupFBOTexture(nDBloomFBO_Texture_1_ID, (int) (ND.SCREEN_SIZE_X * ND.FBO_SCALE_MULTIPLIER * ND.BLOOM_FBO_SCALE), (int) (ND.SCREEN_SIZE_Y * ND.FBO_SCALE_MULTIPLIER * ND.BLOOM_FBO_SCALE));
				nDBloomFBO_Texture_1 = GLUtils.wrapGLTexture(nDBloomFBO_Texture_1_ID, (int) (ND.SCREEN_SIZE_X * ND.FBO_SCALE_MULTIPLIER * ND.BLOOM_FBO_SCALE), (int) (ND.SCREEN_SIZE_Y * ND.FBO_SCALE_MULTIPLIER * ND.BLOOM_FBO_SCALE));
				LWJGLUtils.attachTextureToFBO(1, nDBloomFBO_Texture_1_ID);
				...
				int nDBGFBO_Texture_0_ID = glGenTextures();
				LWJGLUtils.setupFBOTexture(nDBGFBO_Texture_0_ID, nDBGFBOWidth, nDBGFBOHeight);
				nDBGFBO_Texture_0 = GLUtils.wrapGLTexture(nDBGFBO_Texture_0_ID, nDBGFBOWidth, nDBGFBOHeight);
				LWJGLUtils.attachTextureToFBO(0, nDBGFBO_Texture_0_ID);

				int nDBGFBO_Texture_1_ID = glGenTextures();
				LWJGLUtils.setupFBOTexture(nDBGFBO_Texture_1_ID, nDBGFBOWidth, nDBGFBOHeight);
				nDBGFBO_Texture_1 = GLUtils.wrapGLTexture(nDBGFBO_Texture_1_ID, nDBGFBOWidth, nDBGFBOHeight);
				LWJGLUtils.attachTextureToFBO(1, nDBGFBO_Texture_1_ID);
...
//			log.info("extensionsStringHasNVGPUProgram4:"+extensionsStringHasNVGPUProgram4);
	...
	public static void attachTextureToFBO(int attachment, com.badlogic.gdx.graphics.Texture tex) {
		attachTextureToFBO(attachment, tex.getTextureObjectHandle());
	}
	...
	public static com.badlogic.gdx.graphics.Texture setupFBOTexture(com.badlogic.gdx.graphics.Texture tex, int width, int height) {
		setupFBOTexture(tex.getTextureObjectHandle(), width, height);
		return tex;
	}
	...
	public static de.matthiasmann.twl.renderer.Renderer TWLrenderer = null;
