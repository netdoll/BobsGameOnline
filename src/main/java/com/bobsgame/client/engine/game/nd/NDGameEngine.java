...
//	}
	...
	{//=========================================================================================================================
		...
		if(t!=null)
		{
			...
			float tx0 = 0;
			float tx1 = (float)t.getWidth() / (float)t.getWidth();
			float ty0 = 0;
			float ty1 = (float)((float)t.getHeight()/(float)t.getHeight());

			float ratio = (float)(getWidth()/2)/(float)t.getWidth();

			float sx0 = getWidth()/4;
			float sx1 = sx0+getWidth()/2;
			float sy0 = getHeight()/4;
			float sy1 = sy0+(float)(t.getHeight()*ratio);
