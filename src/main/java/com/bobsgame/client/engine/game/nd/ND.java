...
{//=========================================================================================================================
	...
	{//=========================================================================================================================
		...
		widthTextureAspectRatio = ((float)texture.getWidth()/(float)texture.getWidth());
		heightTextureAspectRatio = ((float)texture.getHeight()/(float)texture.getHeight());
		widthToHeightRatio = ((float)texture.getWidth()/(float)texture.getHeight());
	...
	{//=========================================================================================================================
		...
		if(widthThisFrame!=targetWidth)
		{
			...
			nDZoom = zWidth/texture.getWidth();
		}
		else
	...
	{//=========================================================================================================================
		...
		float zWidth = (float)texture.getWidth()*widthTextureAspectRatio*nDZoom;
		float zHeight = (float)texture.getHeight()*heightTextureAspectRatio*nDZoom;
		...
		//302x258
		float inScreenX = (((float)texture.getWidth()-SCREEN_SIZE_X*screenScale)/2)*nDZoom;
		float inScreenY = (((float)texture.getHeight()-SCREEN_SIZE_Y*screenScale)/2)*nDZoom;
		...
		if(LWJGLUtils.useShader)
		{
			if(drawScreenLight)
			{
				...
				GLUtils.bind(LWJGLUtils.mainFBO_lightTexture);
