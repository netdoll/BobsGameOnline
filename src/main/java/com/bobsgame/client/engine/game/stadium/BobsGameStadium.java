...
//		}
	...
	{//=========================================================================================================================
		...
		if(LWJGLUtils.useShader)
		{
			...
			if(fboTextureToggle)GLUtils.bind(LWJGLUtils.nDBGFBO_Texture_1);
			else GLUtils.bind(LWJGLUtils.nDBGFBO_Texture_0);
			...
			glEnable(GL_TEXTURE_2D);
			if(titleScreenTexture!=null)GLUtils.bind(titleScreenTexture);
		...
		if(LWJGLUtils.useShader)
		{
			...
			LWJGLUtils.useShader(LWJGLUtils.maskShader);
				...
				GLUtils.bind(LWJGLUtils.nDFBO_MaskTexture);
			...
			//pingPongTex1.bind(1);
			glActiveTexture(GL_TEXTURE1);
			GLUtils.bind(LWJGLUtils.nDBloomFBO_Texture_0);
