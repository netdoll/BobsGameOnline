	...
	{//=========================================================================================================================
		...
		if(shadowTexture!=null&&disableShadow()==false)
		{
			...
			if(clipShadow==false)
			{
				...
				ty0 = (((float)sprite.h())*getFrame())/texture.getHeight();
				ty1 = ((((float)sprite.h())*(getFrame()+1))-1)/texture.getHeight();
			...
			if(clipShadow==true&&shadowClipPerPixel!=null)
			{
				...
				//bind texture here.
				GLUtils.bind(shadowTexture);

				for(int x=0;x<sprite.w();x++)
				{
					//float w = 1.0f/(float)texture.getWidth();

					tx0 = ((float)x/(float)texture.getWidth());
					tx1 = ((float)(x+1.0f)/(float)texture.getWidth());
					ty0 = (((float)sprite.h())*getFrame())/texture.getHeight();
					ty1 = ((((float)sprite.h())*(getFrame()+1))-1)/texture.getHeight();
					...
					if(shadowClipPerPixel[x]<1.0f)
					{
						...
						ty1=((((((float)sprite.h())*(getFrame()))+((float)sprite.h()*shadowClipPerPixel[x]))-1)/texture.getHeight());
					}
...
//			tx0 = 0.0f;
//			tx1 = ((float)sprite.w()/(float)texture.getWidth());
//			ty0 = (((float)sprite.h())*frameIndexInTexture)/(float)texture.getHeight();
//			ty1 = (((float)sprite.h())*(frameIndexInTexture+1))/(float)texture.getHeight();
//
//
//
