...
{//=========================================================================================================================
	...
	{//=========================================================================================================================
		...
		float ty0 = (float)(32.0f*SpriteManager().actionTextureFrame)/((float)actionTexture.getHeight());
		float ty1 = (float)(32.0f*(SpriteManager().actionTextureFrame+1))/((float)actionTexture.getHeight());
