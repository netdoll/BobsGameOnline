...
/*
		float tx0 = 0.0f;
		float tx1 = 32.0f/((float)actionTexture.getWidth());
		float ty0 = (float)(32.0f*EntityManager.actionTextureFrame)/((float)actionTexture.getHeight());
		float ty1 = (float)(32.0f*(EntityManager.actionTextureFrame+1))/((float)actionTexture.getHeight());
		...
		tx0 = 0.0f;
		tx1 = 32.0f/((float)actionTexture.getWidth());
		ty0 = (float)(32.0f*ACTION_icon_sprite.frameIndexInTexture)/((float)actionTexture.getHeight());
		ty1 = (float)(32.0f*(ACTION_icon_sprite.frameIndexInTexture+1))/((float)actionTexture.getHeight());
...
*/
		...
		float tx0 = 0.0f;
		float tx1 = 32.0f/((float)actionTexture.getWidth());
		float ty0 = (float)(32.0f*10)/((float)actionTexture.getHeight());
		float ty1 = (float)(32.0f*(10+1))/((float)actionTexture.getHeight());
