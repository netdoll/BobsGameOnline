...
//		}
	...
	{// =========================================================================================================================
		...
		tx0=0.0f;// 672 x 160
		tx1=672.0f/borderTexture.getWidth();
		ty0=0.0f;
		ty1=160.0f/borderTexture.getHeight();
...
//		y1=(int)(screenY)+(TextManager().textWindowHeight)+16;
		...
		tx0=0.0f;
		tx1=(float)textBoxTexture.getWidth()/(float)textBoxTexture.getWidth();
		ty0=0.0f;
		ty1=(float)textBoxTexture.getHeight()/(float)textBoxTexture.getHeight();
...
//		y1=(int)((screenY)+(64*2));
	...
	{// =========================================================================================================================
		...
		byte[] oldtex = GLUtils.getTextureData(spriteWindowTexture);
		int size_x=spriteWindowTexture.getWidth();
		int size_y=spriteWindowTexture.getHeight();
